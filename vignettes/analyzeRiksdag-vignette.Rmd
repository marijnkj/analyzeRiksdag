...
> To get an overview of the utskott (committees) that were in place in a particular year, `get_utskott()` may be used. It takes a year in the same format as above.
